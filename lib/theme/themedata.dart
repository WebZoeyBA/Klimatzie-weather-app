...
final ThemeData amazonThemeData = ThemeData(
    ...
    textTheme: const TextTheme(
        displayLarge: TextStyle(
            color: Colors.white, fontSize: 80, fontWeight: FontWeight.w100),
        ...
        bodyLarge: TextStyle(
          ...
          shadows: [
            Shadow(
                color: Colors.black, blurRadius: 10.0, offset: Offset(3.0, 3.0))
          ],
        ),
    ...
    checkboxTheme: CheckboxThemeData(
      checkColor: MaterialStateColor.resolveWith((states) {
        if (states.contains(MaterialState.disabled)) {
          return Colors
              .orange; // Set the desired check color for disabled state
        }
